...
## 🖥️ 프로젝트 소개
**LETTUCE** 는 **SNS 서비스**로 누구나 쉽게 접근 가능하며, 영어로 **“함께하자”** 는 의미인 **“Let Us”** 와 발음이 유사한 것에 영감을 얻어 제작하게 된 프로젝트 입니다. Socket.io 를 활용한 **실시간 채팅 기능**이 있으며, ERD를 활용한 DB 설계를 통해 유저와 게시글 간 **팔로우∙좋아요∙해시태그 기능**을 구현하였습니다.
